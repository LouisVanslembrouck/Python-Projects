...
class App(QMainWindow):
    ...
    def __init__(self):
        ...
        self.search_dir = r'C:\Users\louis\Documents\Receipt_Backup'
    ...
    def download_files(self):
        ...
        for pair in self.files:
            ...
            ssh.connect(hostname=remote_host, username='louisvanslembrouck@gmail.com', password='Botermans123', timeout=4)
